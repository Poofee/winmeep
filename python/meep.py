...
def _get_gradient(grad, scalegrad, fields_a_0, fields_a_1, fields_a_2, fields_f_0, fields_f_1, fields_f_2, grid_volume, frequencies, geps, fd_step):
    return _meep._get_gradient(grad, scalegrad, fields_a_0, fields_a_1, fields_a_2, fields_f_0, fields_f_1, fields_f_2, grid_volume, frequencies, geps, fd_step)
...
class Size_t_Vector(object):
    ...
    def iterator(self):
        return _meep.Size_t_Vector_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _meep.Size_t_Vector___nonzero__(self)

    def __bool__(self):
        return _meep.Size_t_Vector___bool__(self)

    def __len__(self):
        return _meep.Size_t_Vector___len__(self)

    def __getslice__(self, i, j):
        return _meep.Size_t_Vector___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _meep.Size_t_Vector___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _meep.Size_t_Vector___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _meep.Size_t_Vector___delitem__(self, *args)

    def __getitem__(self, *args):
        return _meep.Size_t_Vector___getitem__(self, *args)

    def __setitem__(self, *args):
        return _meep.Size_t_Vector___setitem__(self, *args)

    def pop(self):
        return _meep.Size_t_Vector_pop(self)

    def append(self, x):
        return _meep.Size_t_Vector_append(self, x)

    def empty(self):
        return _meep.Size_t_Vector_empty(self)

    def size(self):
        return _meep.Size_t_Vector_size(self)

    def swap(self, v):
        return _meep.Size_t_Vector_swap(self, v)

    def begin(self):
        return _meep.Size_t_Vector_begin(self)

    def end(self):
        return _meep.Size_t_Vector_end(self)

    def rbegin(self):
        return _meep.Size_t_Vector_rbegin(self)

    def rend(self):
        return _meep.Size_t_Vector_rend(self)

    def clear(self):
        return _meep.Size_t_Vector_clear(self)

    def get_allocator(self):
        return _meep.Size_t_Vector_get_allocator(self)

    def pop_back(self):
        return _meep.Size_t_Vector_pop_back(self)

    def erase(self, *args):
        return _meep.Size_t_Vector_erase(self, *args)

    def __init__(self, *args):
        _meep.Size_t_Vector_swiginit(self, _meep.new_Size_t_Vector(*args))

    def push_back(self, x):
        return _meep.Size_t_Vector_push_back(self, x)

    def front(self):
        return _meep.Size_t_Vector_front(self)

    def back(self):
        return _meep.Size_t_Vector_back(self)

    def assign(self, n, x):
        return _meep.Size_t_Vector_assign(self, n, x)

    def resize(self, *args):
        return _meep.Size_t_Vector_resize(self, *args)

    def insert(self, *args):
        return _meep.Size_t_Vector_insert(self, *args)

    def reserve(self, n):
        return _meep.Size_t_Vector_reserve(self, n)

    def capacity(self):
        return _meep.Size_t_Vector_capacity(self)
    __swig_destroy__ = _meep.delete_Size_t_Vector

# Register Size_t_Vector in _meep:
_meep.Size_t_Vector_swigregister(Size_t_Vector)
...
def is_E_or_D(c):
    return _meep.is_E_or_D(c)

def is_H_or_B(c):
    return _meep.is_H_or_B(c)
...
class ivec(object):
    ...
    def __truediv__(self, *args):
        return _meep.ivec___truediv__(self, *args)
    __div__ = __truediv__
    ...
    def round_down_to_even(self):
        return _meep.ivec_round_down_to_even(self)
...
class grid_volume(object):
    ...
    def subvolume(self, _is, ie, c):
        return _meep.grid_volume_subvolume(self, _is, ie, c)

    def init_subvolume(self, _is, ie, c):
        return _meep.grid_volume_init_subvolume(self, _is, ie, c)
    ...
    def big_owned_corner(self, c):
        return _meep.grid_volume_big_owned_corner(self, c)
    ...
    def split_at_fraction(self, side_high, split_pt, split_dir):
        return _meep.grid_volume_split_at_fraction(self, side_high, split_pt, split_dir)
    ...
    def get_split_costs(self, d, split_point, frag_cost):
        return _meep.grid_volume_get_split_costs(self, d, split_point, frag_cost)

    def tile_split(self, best_split_point, best_split_direction):
        return _meep.grid_volume_tile_split(self, best_split_point, best_split_direction)

    def find_best_split(self, desired_chunks, frag_cost, best_split_point, best_split_direction, left_effort_fraction):
        return _meep.grid_volume_find_best_split(self, desired_chunks, frag_cost, best_split_point, best_split_direction, left_effort_fraction)
...
class symmetry(object):
    ...
    def multiplicity(self, *args):
        return _meep.symmetry_multiplicity(self, *args)
    ...
    i_symmetry_point = property(_meep.symmetry_i_symmetry_point_get, _meep.symmetry_i_symmetry_point_set)
...
class susceptibility(object):
    ...
    def has_nonlinearities(self):
        return _meep.susceptibility_has_nonlinearities(self)
...
class multilevel_susceptibility(susceptibility):
    ...
    def has_nonlinearities(self):
        return _meep.multilevel_susceptibility_has_nonlinearities(self)
...
class h5file(object):
    ...
    def create_or_extend_data(self, dataname, rank, dims, append_data, single_precision=True):
...
class structure_chunk(object):
    ...
    def has_nonlinearities(self):
        return _meep.structure_chunk_has_nonlinearities(self)
...
class structure(object):
    ...
    def dump(self, filename, single_parallel_file=True):
        return _meep.structure_dump(self, filename, single_parallel_file)

    def load(self, filename, single_parallel_file=True):
        return _meep.structure_load(self, filename, single_parallel_file)
    ...
    def get_binary_partition(self):
        return _meep.structure_get_binary_partition(self)

# Register structure in _meep:
_meep.structure_swigregister(structure)
NUM_CONNECT_PHASE_TYPES = cvar.NUM_CONNECT_PHASE_TYPES


def split_by_binarytree(gvol, result_gvs, result_ids, bp):
    return _meep.split_by_binarytree(gvol, result_gvs, result_ids, bp)
class src_time(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    is_integrated = property(_meep.src_time_is_integrated_get, _meep.src_time_is_integrated_set)
    id = property(_meep.src_time_id_get, _meep.src_time_id_set)
    ...
    def get_fwidth(self):
        return _meep.src_time_get_fwidth(self)

    def set_fwidth(self, fw):
        return _meep.src_time_set_fwidth(self, fw)
...
class gaussian_src_time(src_time):
    ...
    def get_fwidth(self):
        return _meep.gaussian_src_time_get_fwidth(self)

    def set_fwidth(self, fw):
        return _meep.gaussian_src_time_set_fwidth(self, fw)
...
class continuous_src_time(src_time):
    ...
    def get_fwidth(self):
        return _meep.continuous_src_time_get_fwidth(self)
...
class custom_src_time(src_time):
    ...
    def get_fwidth(self):
        return _meep.custom_src_time_get_fwidth(self)

    def set_fwidth(self, fw):
        return _meep.custom_src_time_set_fwidth(self, fw)
...
class dft_chunk(object):
    ...
    def norm2(self, fgv):
        return _meep.dft_chunk_norm2(self, fgv)

    def maxomega(self):
        return _meep.dft_chunk_maxomega(self)
    ...
    def get_decimation_factor(self):
        return _meep.dft_chunk_get_decimation_factor(self)
    ...
    persist = property(_meep.dft_chunk_persist_get, _meep.dft_chunk_persist_set)
    ...
    is_old = property(_meep.dft_chunk_is_old_get, _meep.dft_chunk_is_old_set)
    ie_old = property(_meep.dft_chunk_ie_old_get, _meep.dft_chunk_ie_old_set)
...
class dft_ldos(object):
    ...
    def overall_scale(self):
        return _meep.dft_ldos_overall_scale(self)
...
class dft_fields(object):
    ...
    def fourier_sourcedata(self, where, c, f, dJ):
        return _meep.dft_fields_fourier_sourcedata(self, where, c, f, dJ)
...
MpiAllTime = _meep.MpiAllTime
MpiOneTime = _meep.MpiOneTime
...
Other = _meep.Other
FieldUpdateB = _meep.FieldUpdateB
FieldUpdateH = _meep.FieldUpdateH
FieldUpdateD = _meep.FieldUpdateD
FieldUpdateE = _meep.FieldUpdateE
BoundarySteppingB = _meep.BoundarySteppingB
BoundarySteppingWH = _meep.BoundarySteppingWH
BoundarySteppingPH = _meep.BoundarySteppingPH
BoundarySteppingH = _meep.BoundarySteppingH
BoundarySteppingD = _meep.BoundarySteppingD
BoundarySteppingWE = _meep.BoundarySteppingWE
BoundarySteppingPE = _meep.BoundarySteppingPE
BoundarySteppingE = _meep.BoundarySteppingE
...
class fields(object):
    ...
    loop_tile_base_db = property(_meep.fields_loop_tile_base_db_get, _meep.fields_loop_tile_base_db_set)
    loop_tile_base_eh = property(_meep.fields_loop_tile_base_eh_get, _meep.fields_loop_tile_base_eh_set)
    ...
    def log(self, *args):
        return _meep.fields_log(self, *args)

    def change_m(self, new_m):
        return _meep.fields_change_m(self, new_m)

    def has_nonlinearities(self, parallel=True):
        return _meep.fields_has_nonlinearities(self, parallel)

    def time_spent_on(self, sink):
        return _meep.fields_time_spent_on(self, sink)
    ...
    def dump(self, filename, single_parallel_file=True):
        return _meep.fields_dump(self, filename, single_parallel_file)

    def load(self, filename, single_parallel_file=True):
        return _meep.fields_load(self, filename, single_parallel_file)
    ...
    def is_aniso2d(self):
        return _meep.fields_is_aniso2d(self)

    def require_source_components(self):
        return _meep.fields_require_source_components(self)

    def _require_component(self, c, aniso2d):
        return _meep.fields__require_component(self, c, aniso2d)

    def require_component(self, c):
        return _meep.fields_require_component(self, c)

    def add_srcdata(self, cur_data, src, n, amp_arr, needs_boundary_fix):
        return _meep.fields_add_srcdata(self, cur_data, src, n, amp_arr, needs_boundary_fix)

    def register_src_time(self, src):
        return _meep.fields_register_src_time(self, src)

    def lookup_src_time(self, id):
        return _meep.fields_lookup_src_time(self, id)
    ...
    @staticmethod
    def vec2diel_floor(pt, a, equal_shift):
        return _meep.fields_vec2diel_floor(pt, a, equal_shift)

    @staticmethod
    def vec2diel_ceil(pt, a, equal_shift):
        return _meep.fields_vec2diel_ceil(pt, a, equal_shift)
    ...
    def dft_norm(self):
        return _meep.fields_dft_norm(self)

    def dft_maxfreq(self):
        return _meep.fields_dft_maxfreq(self)

    def max_decimation(self):
        return _meep.fields_max_decimation(self)

    def clear_dft_monitors(self):
        return _meep.fields_clear_dft_monitors(self)
    ...
    def dft_monitor_size(self, fdft, where, c):
        return _meep.fields_dft_monitor_size(self, fdft, where, c)

    def get_dft_component_dims(self, chunklists, num_chunklists, c, min_corner, max_corner, array_size, bufsz, rank, ds, dims, array_rank=None, array_dims=None, array_dirs=None):
        return _meep.fields_get_dft_component_dims(self, chunklists, num_chunklists, c, min_corner, max_corner, array_size, bufsz, rank, ds, dims, array_rank, array_dims, array_dirs)
    ...
    def process_incoming_chunk_data(self, ft, comm_pair):
        return _meep.fields_process_incoming_chunk_data(self, ft, comm_pair)
    ...
    def am_now_working_on(self, sink):
        return _meep.fields_am_now_working_on(self, sink)

    def finished_working(self):
        return _meep.fields_finished_working(self)

    def get_timing_data(self):
        return _meep.fields_get_timing_data(self)
...
class split_plane(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    dir = property(_meep.split_plane_dir_get, _meep.split_plane_dir_set)
    pos = property(_meep.split_plane_pos_get, _meep.split_plane_pos_set)

    def __init__(self):
        _meep.split_plane_swiginit(self, _meep.new_split_plane())
    __swig_destroy__ = _meep.delete_split_plane

# Register split_plane in _meep:
_meep.split_plane_swigregister(split_plane)
class binary_partition(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, *args):
        _meep.binary_partition_swiginit(self, _meep.new_binary_partition(*args))

    def is_leaf(self):
        return _meep.binary_partition_is_leaf(self)

    def get_proc_id(self):
        return _meep.binary_partition_get_proc_id(self)

    def get_plane(self):
        return _meep.binary_partition_get_plane(self)

    def left_tree(self):
        return _meep.binary_partition_left_tree(self)

    def right_tree(self):
        return _meep.binary_partition_right_tree(self)
    __swig_destroy__ = _meep.delete_binary_partition

# Register binary_partition in _meep:
_meep.binary_partition_swigregister(binary_partition)

def set_zero_subnormals(iszero):
    return _meep.set_zero_subnormals(iszero)

def setup():
    return _meep.setup()

def split_into_tiles(gvol, result, loop_tile_base):
    return _meep.split_into_tiles(gvol, result, loop_tile_base)

def check_tiles(gv, gvs):
    return _meep.check_tiles(gv, gvs)
...
CYLINDRICAL = cvar.CYLINDRICAL
X_DIR = cvar.X_DIR
Y_DIR = cvar.Y_DIR
Z_DIR = cvar.Z_DIR
R_DIR = cvar.R_DIR
PHI_DIR = cvar.PHI_DIR
ALL_SIDES = cvar.ALL_SIDES
ALL_DIRECTIONS = cvar.ALL_DIRECTIONS
ENORMOUS = cvar.ENORMOUS
TINY = cvar.TINY
...
class symm_matrix(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    m00 = property(_meep.symm_matrix_m00_get, _meep.symm_matrix_m00_set)
    m01 = property(_meep.symm_matrix_m01_get, _meep.symm_matrix_m01_set)
    m02 = property(_meep.symm_matrix_m02_get, _meep.symm_matrix_m02_set)
    m11 = property(_meep.symm_matrix_m11_get, _meep.symm_matrix_m11_set)
    m12 = property(_meep.symm_matrix_m12_get, _meep.symm_matrix_m12_set)
    m22 = property(_meep.symm_matrix_m22_get, _meep.symm_matrix_m22_set)

    def __init__(self):
        _meep.symm_matrix_swiginit(self, _meep.new_symm_matrix())
    __swig_destroy__ = _meep.delete_symm_matrix

# Register symm_matrix in _meep:
_meep.symm_matrix_swigregister(symm_matrix)
class pol(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    user_s = property(_meep.pol_user_s_get, _meep.pol_user_s_set)
    next = property(_meep.pol_next_get, _meep.pol_next_set)

    def __init__(self):
        _meep.pol_swiginit(self, _meep.new_pol())
    __swig_destroy__ = _meep.delete_pol

# Register pol in _meep:
_meep.pol_swigregister(pol)
class cond_profile(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    L = property(_meep.cond_profile_L_get, _meep.cond_profile_L_set)
    N = property(_meep.cond_profile_N_get, _meep.cond_profile_N_set)
    prof = property(_meep.cond_profile_prof_get, _meep.cond_profile_prof_set)

    def __init__(self):
        _meep.cond_profile_swiginit(self, _meep.new_cond_profile())
    __swig_destroy__ = _meep.delete_cond_profile

# Register cond_profile in _meep:
_meep.cond_profile_swigregister(cond_profile)
class geom_epsilon(material_function):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    u_p = property(_meep.geom_epsilon_u_p_get, _meep.geom_epsilon_u_p_set)
    geometry_tree = property(_meep.geom_epsilon_geometry_tree_get, _meep.geom_epsilon_geometry_tree_set)
    restricted_tree = property(_meep.geom_epsilon_restricted_tree_get, _meep.geom_epsilon_restricted_tree_set)
    geometry = property(_meep.geom_epsilon_geometry_get, _meep.geom_epsilon_geometry_set)
    cond = property(_meep.geom_epsilon_cond_get, _meep.geom_epsilon_cond_set)
    tol = property(_meep.geom_epsilon_tol_get, _meep.geom_epsilon_tol_set)
    maxeval = property(_meep.geom_epsilon_maxeval_get, _meep.geom_epsilon_maxeval_set)

    def __init__(self, *args):
        _meep.geom_epsilon_swiginit(self, _meep.new_geom_epsilon(*args))
    __swig_destroy__ = _meep.delete_geom_epsilon

    def set_cond_profile(self, arg2, arg3, L, dx, prof, arg7, R):
        return _meep.geom_epsilon_set_cond_profile(self, arg2, arg3, L, dx, prof, arg7, R)

    def set_volume(self, v):
        return _meep.geom_epsilon_set_volume(self, v)

    def unset_volume(self):
        return _meep.geom_epsilon_unset_volume(self)

    def has_chi(self, c, p):
        return _meep.geom_epsilon_has_chi(self, c, p)

    def has_chi3(self, c):
        return _meep.geom_epsilon_has_chi3(self, c)

    def has_chi2(self, c):
        return _meep.geom_epsilon_has_chi2(self, c)

    def chi(self, c, r, p):
        return _meep.geom_epsilon_chi(self, c, r, p)

    def chi3(self, c, r):
        return _meep.geom_epsilon_chi3(self, c, r)

    def chi2(self, c, r):
        return _meep.geom_epsilon_chi2(self, c, r)

    def has_mu(self):
        return _meep.geom_epsilon_has_mu(self)

    def has_conductivity(self, c):
        return _meep.geom_epsilon_has_conductivity(self, c)

    def conductivity(self, c, r):
        return _meep.geom_epsilon_conductivity(self, c, r)

    def chi1p1(self, ft, r):
        return _meep.geom_epsilon_chi1p1(self, ft, r)

    def eff_chi1inv_row(self, c, chi1inv_row, v, tol, maxeval):
        return _meep.geom_epsilon_eff_chi1inv_row(self, c, chi1inv_row, v, tol, maxeval)

    def eff_chi1inv_matrix(self, c, chi1inv_matrix, v, tol, maxeval, fallback):
        return _meep.geom_epsilon_eff_chi1inv_matrix(self, c, chi1inv_matrix, v, tol, maxeval, fallback)

    def fallback_chi1inv_row(self, c, chi1inv_row, v, tol, maxeval):
        return _meep.geom_epsilon_fallback_chi1inv_row(self, c, chi1inv_row, v, tol, maxeval)

    def sigma_row(self, c, sigrow, r):
        return _meep.geom_epsilon_sigma_row(self, c, sigrow, r)

    def add_susceptibilities(self, *args):
        return _meep.geom_epsilon_add_susceptibilities(self, *args)

    def get_material_pt(self, material, r):
        return _meep.geom_epsilon_get_material_pt(self, material, r)

# Register geom_epsilon in _meep:
_meep.geom_epsilon_swigregister(geom_epsilon)

def set_dimensions(dims):
    return _meep.set_dimensions(dims)

def make_geom_epsilon(*args):
    return _meep.make_geom_epsilon(*args)
...
def make_material_grid(do_averaging, beta, eta, damping):
    return _meep.make_material_grid(do_averaging, beta, eta, damping)
...
def set_default_material(_default_material):
    return _meep.set_default_material(_default_material)

def unset_default_material():
    return _meep.unset_default_material()
...
def get_epsilon_grid(gobj_list, mlist, _default_material, _ensure_periodicity, gv, cell_size, cell_center, nx, x, ny, y, nz, z, grid_vals, frequency=0):
    return _meep.get_epsilon_grid(gobj_list, mlist, _default_material, _ensure_periodicity, gv, cell_size, cell_center, nx, x, ny, y, nz, z, grid_vals, frequency)

def init_libctl(default_mat, ensure_per, gv, cell_size, cell_center, geom_list):
    return _meep.init_libctl(default_mat, ensure_per, gv, cell_size, cell_center, geom_list)

def update_weights(matgrid, weights):
    return _meep.update_weights(matgrid, weights)

def matgrid_grad(p, tp, oi, md):
    return _meep.matgrid_grad(p, tp, oi, md)

def material_grid_grad(p, md, o):
    return _meep.material_grid_grad(p, md, o)
...
def material_grids_addgradient(v, ng, nf, fields_a, fields_f, frequencies, scalegrad, gv, geps, du=1e-6):
    return _meep.material_grids_addgradient(v, ng, nf, fields_a, fields_f, frequencies, scalegrad, gv, geps, du)
...
class custom_py_src_time(src_time):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, *args):
        _meep.custom_py_src_time_swiginit(self, _meep.new_custom_py_src_time(*args))
    __swig_destroy__ = _meep.delete_custom_py_src_time

    def current(self, time, dt):
        return _meep.custom_py_src_time_current(self, time, dt)

    def dipole(self, time):
        return _meep.custom_py_src_time_dipole(self, time)

    def last_time(self):
        return _meep.custom_py_src_time_last_time(self)

    def clone(self):
        return _meep.custom_py_src_time_clone(self)

    def is_equal(self, t):
        return _meep.custom_py_src_time_is_equal(self, t)

    def frequency(self):
        return _meep.custom_py_src_time_frequency(self)

    def set_frequency(self, f):
        return _meep.custom_py_src_time_set_frequency(self, f)

    def get_fwidth(self):
        return _meep.custom_py_src_time_get_fwidth(self)

    def set_fwidth(self, fw):
        return _meep.custom_py_src_time_set_fwidth(self, fw)

# Register custom_py_src_time in _meep:
_meep.custom_py_src_time_swigregister(custom_py_src_time)
...
def _set_materials(s, cell_size, gv, use_anisotropic_averaging, tol, maxeval, gobj_list, center, _ensure_periodicity, _default_material, alist, extra_materials, split_chunks_evenly, set_materials, existing_geps, output_chunk_costs, my_bp):
...
def _get_epsilon_grid(gobj_list, mlist, _default_material, _ensure_periodicity, gv, cell_size, cell_center, nx, xtics, ny, ytics, nz, ztics, grid_vals, frequency):
