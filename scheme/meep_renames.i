...
%rename(meep_binary_partition) meep::binary_partition;
%rename(meep_boundary_region) meep::boundary_region;
%rename(meep_chunkloop_field_components) meep::chunkloop_field_components;
...
%rename(meep_dft_energy) meep::dft_energy;
%rename(meep_dft_fields) meep::dft_fields;
...
%rename(meep_diffractedplanewave) meep::diffractedplanewave;
%rename(meep_fields) meep::fields;
%rename(meep_flux_vol) meep::flux_vol;
%rename(meep_gaussian_src_time) meep::gaussian_src_time;
%rename(meep_gaussianbeam) meep::gaussianbeam;
%rename(meep_grid_volume) meep::grid_volume;
%rename(meep_gyrotropic_susceptibility) meep::gyrotropic_susceptibility;
...
%rename(meep_bw_or_to_all) meep::bw_or_to_all;
%rename(meep_cdouble) meep::cdouble;
%rename(meep_check_tiles) meep::check_tiles;
...
%rename(meep_delete_directory) meep::delete_directory;
%rename(meep_derived_component_func) meep::derived_component_func;
%rename(meep_destroy_eigenmode_data) meep::destroy_eigenmode_data;
...
%rename(meep_eigenmode_amplitude) meep::eigenmode_amplitude;
...
%rename(meep_get_group_velocity) meep::get_group_velocity;
%rename(meep_get_k) meep::get_k;
...
%rename(meep_is_E_or_D) meep::is_E_or_D;
%rename(meep_is_H_or_B) meep::is_H_or_B;
...
%rename(meep_linear_interpolate) meep::linear_interpolate;
%rename(meep_linspace) meep::linspace;
...
%rename(meep_master_printf_stderr) meep::master_printf_stderr;
%rename(meep_matrix_invert) meep::matrix_invert;
...
%rename(meep_min_to_all) meep::min_to_all;
...
%rename(meep_restore_random_seed) meep::restore_random_seed;
...
%rename(meep_set_meep_printf_callback) meep::set_meep_printf_callback;
%rename(meep_set_meep_printf_stderr_callback) meep::set_meep_printf_stderr_callback;
%rename(meep_set_random_seed) meep::set_random_seed;
%rename(meep_set_zero_subnormals) meep::set_zero_subnormals;
%rename(meep_setup) meep::setup;
%rename(meep_split_by_binarytree) meep::split_by_binarytree;
%rename(meep_split_into_tiles) meep::split_into_tiles;
...
%rename(meep_with_mpi) meep::with_mpi;
